...
\begin{equation}
    ...
    \label{neutrino_to_ppe}
\end{equation}
\begin{equation}
    \nu + d \rightarrow  n + p + \nu
    \label{neutrino_to_npv}
\end{equation}
